...
void Scene::render(GLint modelUniform, GLint colorUniform, float currentFrame) const
{
    ...
    planet1.render(modelUniform, colorUniform, planet1Model);
    ...
    planet2.render(modelUniform, colorUniform, planet2Model);
    ...
    planet3.render(modelUniform, colorUniform, planet3Model);
}